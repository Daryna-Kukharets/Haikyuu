...
declare const linthtml: {
     ...
     */
    create_linters_for_files(globs: string[], config_path?: string): Promise<FileLinter[]>;
    from_config_path(config_path: string): Promise<Linter | LegacyLinter>;
    Linter: typeof Linter;
    LegacyLinter: typeof LegacyLinter;
    rules: import("./read-config.js").LegacyRuleDefinition[];
    presets: {
